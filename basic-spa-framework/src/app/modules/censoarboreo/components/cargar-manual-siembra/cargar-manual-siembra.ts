...
@Component({
  selector: 'app-cargar-manual-siembra',
  templateUrl: './cargar-manual-siembra.html',
  styleUrls: ['./cargar-manual-siembra.scss']
})
export class CargarManualActividadesSiembraComponent {
  ...
  cargarArchivo()
  {
    ...
    this.service.uploadFileSiembra(fd,this.selectedFile.size).subscribe(
      (res) => {
        //console.log(res);
