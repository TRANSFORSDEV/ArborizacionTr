...
@Component({
  selector: 'app-cargar-manual-tala',
  templateUrl: './cargar-manual-tala.html',
  styleUrls: ['./cargar-manual-tala.scss']
})
export class CargarManualActividadesTalaComponent {
  ...
  cargarArchivo()
  {
    ...
    this.service.uploadFileTala(fd,this.selectedFile.size).subscribe(
      (res) => {
        //console.log(res);
